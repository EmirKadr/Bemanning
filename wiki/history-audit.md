...
| Typ | Filtrerar entity type | Skickar `entity_type` | `entityFilter` | Typnamn ar tekniska, t.ex. `schedule_cell`. |
...
| "Varfor syns inte min andring?" | Kontrollera periodfilter och att andringen verkligen loggas av backendflodet. Alla muterande floden kanske inte historikfor allt. |
