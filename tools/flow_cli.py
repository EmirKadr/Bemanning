...
ROUTES: tuple[ApiRoute, ...] = (
    ...
    ApiRoute("query_data.health", "GET", "/api/query-data/health", "Datahämtning health"),
    ApiRoute("query_data.reload_catalog", "POST", "/api/query-data/catalog/reload", "Läs om extern datakatalog"),
    ...
    ApiRoute("allocation.process_matrix_get", "GET", "/api/allokering/process-matrix", "Hämta Bearbeta-matris"),
    ApiRoute("allocation.process_matrix_update", "PUT", "/api/allokering/process-matrix", "Uppdatera Bearbeta-matris"),
    ...
    ApiRoute("coredata.files", "GET", "/api/coredata/files", "Coredata-kärnfiler och sammanställd data för verksamheten"),
    ApiRoute("coredata.upload_raw", "POST", "/api/coredata/files/raw", "Ladda upp coredata-kärnfil eller sammanställd datafil"),
    ...
    ApiRoute("persons.sort_order", "PUT", "/api/persons/sort-order", "Sortera personer inom anvandarens omrade"),
    ...
    ApiRoute("productivity.upload_raw", "POST", "/api/productivity/files/raw", "Ladda upp rå produktivitetsfil och uppdatera sammanställda loggar"),
