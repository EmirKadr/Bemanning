...
ROUTES: tuple[ApiRoute, ...] = (
    ...
    ApiRoute("coredata.files", "GET", "/api/coredata/files", "Coredata-kärnfiler för verksamheten"),
    ApiRoute("coredata.upload_raw", "POST", "/api/coredata/files/raw", "Ladda upp coredata-kärnfil"),
